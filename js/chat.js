(function () {
  ...
  function renderMessage(msg) {
    ...
    // Get raw plain text directly (Censoring filter removed)
    const plainTextContent = stripAttachmentFromContent(msg.content || '');
    
    // Parse emotes & mentions
